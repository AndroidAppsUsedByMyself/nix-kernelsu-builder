...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  lineage-nightly-pstar_bootImg = {
    ...
    version = "20250505";
    src = fetchurl {
      url = "https://mirrorbits.lineageos.org/full/pstar/20250505/boot.img";
      sha256 = "sha256-IDa8+TuWz/5qhrkF6wVXhEXIjZOpO0ruauMfUUSuYCI=";
    };
  };
  linux-amazon-karnak = {
  ...
  wildplus-kernel-patches = {
    ...
    version = "e1e4ad33ccf906c5891505e2215af5724ba87780";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "e1e4ad33ccf906c5891505e2215af5724ba87780";
      fetchSubmodules = false;
      sha256 = "sha256-s5nbhck2BJ+dlmRNTbAvtOnZ1Pzl29Vt5nqS7A8k+ko=";
    };
    date = "2025-05-04";
  };
