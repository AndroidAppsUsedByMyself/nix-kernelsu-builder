...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  kernelsu-rksu = {
    pname = "kernelsu-rksu";
    version = "v1.0.3-35-legacy";
    src = fetchgit {
      url = "https://github.com/rsuntk/KernelSU.git";
      rev = "v1.0.3-35-legacy";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-cBh5ts00bWUX3bORwjj9qzZYNoAWM6tea5yJPG5wTOo=";
    };
  };
  ...
  lineage-nightly-pstar_bootImg = {
    ...
    version = "20250317";
    src = fetchurl {
      url = "https://mirrorbits.lineageos.org/full/pstar/20250317/boot.img";
      sha256 = "sha256-K+y47N09D7WAdfsR4ONEfLbqzU10MDr7E/Eq+U7VK5c=";
    };
  };
  linux-amazon-karnak = {
  ...
  wildplus-kernel-patches = {
    ...
    version = "bea890dc8a9cde7b0d26ac53e8ddfbb8e9095d76";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "bea890dc8a9cde7b0d26ac53e8ddfbb8e9095d76";
      fetchSubmodules = false;
      sha256 = "sha256-UMjkENX6FnJGjfF4i2/pzpJ4E+wRLQn4aKRDCWpARGE=";
    };
    date = "2025-03-17";
  };
