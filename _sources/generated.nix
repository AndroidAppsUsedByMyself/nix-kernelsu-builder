...
}:
{
  ...
  AAAAA_lineage-nightly-pstar_bootImg = {
    ...
    version = "20260629";
    src = fetchurl {
      url = "https://mirrorbits.lineageos.org/full/pstar/20260629/boot.img";
      sha256 = "sha256-dUJ2w1Q8Z3jxd12RoHw88rgPxQNM6DuHJ1KskUfFWgE=";
    };
  };
  ...
  wildplus-kernel-patches = {
    ...
    version = "f39a0fc5cd53f18e754cae0e7e6969147a7abda4";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "f39a0fc5cd53f18e754cae0e7e6969147a7abda4";
      fetchSubmodules = false;
      sha256 = "sha256-MLtk4G271krHrpCXvJknJltwCSMw76ViwfQbhtZM/7I=";
    };
    date = "2026-06-30";
  };
}
