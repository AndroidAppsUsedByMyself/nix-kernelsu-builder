...
}:
{
  ...
  AAAAA_lineage-nightly-pstar_bootImg = {
    ...
    version = "20260316";
    src = fetchurl {
      url = "https://mirrorbits.lineageos.org/full/pstar/20260316/boot.img";
      sha256 = "sha256-5vEojVGLW4iSWdCjUSgWAr0Yay5VupYoKz9R6BHgaXE=";
    };
  };
  ...
  baseband-guard = {
    ...
    version = "a531519779e844e21e9da74f3047a59041401d7b";
    src = fetchFromGitHub {
      owner = "vc-teahouse";
      repo = "Baseband-guard";
      rev = "a531519779e844e21e9da74f3047a59041401d7b";
      fetchSubmodules = false;
      sha256 = "sha256-L7Hrs3Lrq16Afz2uwUdQEMP6svvy5NTcM3NB17AY2SY=";
    };
    date = "2026-03-19";
  };
  ...
  sukisu = {
    pname = "sukisu";
    version = "89898233761d2cb949216525f0e47e60a77e052b";
    src = fetchFromGitHub {
      owner = "SukiSU-Ultra";
      repo = "SukiSU-Ultra";
      rev = "89898233761d2cb949216525f0e47e60a77e052b";
      fetchSubmodules = false;
      sha256 = "sha256-jXAbfxMQApHaGsbaSaoIXw8nk9KOP1ojYyjepKUJObw=";
    };
    date = "2026-03-20";
  };
  sukisu-nongki = {
  ...
  susfs-android13-5_15 = {
    ...
    version = "20303f6d3eb043fa04a7590b0e9f1c70a7d008e9";
    src = fetchgit {
      url = "https://gitlab.com/simonpunk/susfs4ksu.git";
      rev = "20303f6d3eb043fa04a7590b0e9f1c70a7d008e9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Bk8w6CZLOjhgyZpmx6hJoWZbO/vtS9amcOpgoKcs+xA=";
    };
    date = "2026-03-20";
  };
  susfs-android15-6_6 = {
    pname = "susfs-android15-6_6";
    version = "2e3f3907dfbebbb96e2fe737a856d58829e3db25";
    src = fetchgit {
      url = "https://gitlab.com/simonpunk/susfs4ksu.git";
      rev = "2e3f3907dfbebbb96e2fe737a856d58829e3db25";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-T7mWnQh2iksxT+yhZf2k3T42WbQYHyCkqCXydt2vBpg=";
    };
    date = "2026-03-20";
  };
  wildplus-kernel-patches = {
    pname = "wildplus-kernel-patches";
    version = "e2647600959bbb5cf723e59ccbbfbe5a41aca5e4";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "e2647600959bbb5cf723e59ccbbfbe5a41aca5e4";
      fetchSubmodules = false;
      sha256 = "sha256-X9P77YQe3uGacshKNp1yW378sDl1TCn9h+P4TP+YcdA=";
    };
    date = "2026-03-20";
  };
}
