...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  lineage-nightly-pstar_bootImg = {
    ...
    version = "20250224";
    src = fetchurl {
      url = "https://mirrorbits.lineageos.org/full/pstar/20250224/boot.img";
      sha256 = "sha256-NoNxp8ZasPVEMey8NaHpD1HR4W7wlhJotJ6aBHx7Ua4=";
    };
  };
  linux-amazon-karnak = {
  ...
  wildplus-kernel-patches = {
    ...
    version = "590bffd366c6b6ecb3b33ffa08787fb2923a9e28";
    src = fetchFromGitHub {
      owner = "WildPlusKernel";
      repo = "kernel_patches";
      rev = "590bffd366c6b6ecb3b33ffa08787fb2923a9e28";
      fetchSubmodules = false;
      sha256 = "sha256-EPnlFrP1FxFX14bifXsZqn/KXOdif1m+IP/lE6b8XJg=";
    };
    date = "2025-03-01";
  };
